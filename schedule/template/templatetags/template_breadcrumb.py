...
@register.simple_tag(takes_context=True, name='gwhcp_template_breadcrumb')
...
@register.simple_tag(takes_context=True, name='gwhcp_template_meta_description')
...
@register.simple_tag(takes_context=True, name='gwhcp_template_meta_keyword')
...
@register.simple_tag(takes_context=True, name='gwhcp_template_title')
def title(context):
    """
    Title
